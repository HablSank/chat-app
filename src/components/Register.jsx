...
export default function Register({ onSwitchToLogin }) {
  ...
  return (
    <div className="min-h-[100dvh] bg-zinc-950 flex items-center justify-center relative overflow-y-auto py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute top-0 right-0 w-[350px] sm:w-[500px] lg:w-[800px] h-[350px] sm:h-[500px] lg:h-[800px] bg-violet-500/10 blur-[140px] rounded-full pointer-events-none translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 left-0 w-[350px] sm:w-[500px] lg:w-[800px] h-[350px] sm:h-[500px] lg:h-[800px] bg-indigo-600/15 blur-[140px] rounded-full pointer-events-none -translate-x-1/3 translate-y-1/3"></div>
        ...
        <div className="flex items-center justify-center w-full">
          ...
          >
            <div className="text-center mb-6 sm:mb-8 lg:mb-10">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-zinc-100">Create Account</h2>
              <p className="text-xs sm:text-base lg:text-lg text-zinc-400 mt-1.5 sm:mt-2">Join to start chatting</p>
            </div>
